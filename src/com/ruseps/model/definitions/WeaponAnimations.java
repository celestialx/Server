...
public final class WeaponAnimations {
	...
	public static int getAttackAnimation(Player c) {
		...
		if (weaponName.contains("karil"))
			return 2075;
		else if (weaponName.contains("Twisted bow") || weaponName.contains("'bow") || weaponName.contains("crossbow"))
			return 4230;
		if (weaponName.contains("Twisted bow") && !weaponName.contains("'bow"))
			return 426;
		...
		case 3626:
		case 625:
			//the right anim, fucking ruse, load of bullshit, adam trinity
			return 1658;
