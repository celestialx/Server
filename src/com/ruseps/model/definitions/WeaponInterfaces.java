...
public final class WeaponInterfaces {
	...
	public enum WeaponInterface {
		...
		//Fasted
		FASTWHIP0(12290, 12293, 0, new FightType[] { FightType.WHIP_FLICK,
				FightType.WHIP_LASH, FightType.WHIP_DEFLECT }, 12323, 12335),
		FASTWHIP1(12290, 12293, 1, new FightType[] { FightType.WHIP_FLICK,
				FightType.WHIP_LASH, FightType.WHIP_DEFLECT }, 12323, 12335),
		FASTWHIP2(12290, 12293, 2, new FightType[] { FightType.WHIP_FLICK,
				FightType.WHIP_LASH, FightType.WHIP_DEFLECT }, 12323, 12335),
		FASTWHIP3(12290, 12293, 3, new FightType[] { FightType.WHIP_FLICK,
				FightType.WHIP_LASH, FightType.WHIP_DEFLECT }, 12323, 12335),
		FASTWHIP4(12290, 12293, 4, new FightType[] { FightType.WHIP_FLICK,
				FightType.WHIP_LASH, FightType.WHIP_DEFLECT }, 12323, 12335),
		FASTWHIP5(12290, 12293, 5, new FightType[] { FightType.WHIP_FLICK,
				FightType.WHIP_LASH, FightType.WHIP_DEFLECT }, 12323, 12335),
		//Slowest
		FASTWHIP6(12290, 12293, 6, new FightType[] { FightType.WHIP_FLICK,
				FightType.WHIP_LASH, FightType.WHIP_DEFLECT }, 12323, 12335),
