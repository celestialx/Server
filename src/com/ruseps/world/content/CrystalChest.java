...
public class CrystalChest {
	...
	public static void handleChest(final Player p, final GameObject chest) {
		...
		if (p.getRights() == PlayerRights.EPIC_DONATOR  || p.getRights() == PlayerRights.ADMINISTRATOR) {
		...
		if (p.getRights() == PlayerRights.LEGENDARY_DONATOR || p.getRights() == PlayerRights.RUBY_MEMBER || p.getRights() == PlayerRights.DEVELOPER) {
