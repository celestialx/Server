...
public class PlayerPanel {
	...
	public static void refreshPanel(Player player) {
		...
		player.getPacketSender().sendString(26712,
				"@or2@Rank:  @gre@" + Misc.formatText(player.getRights().toString().toLowerCase()));
		player.getPacketSender().sendString(26714,
				"@or2@Email:  @gre@"
		 ...
		 * Slayer
		 */
		player.getPacketSender().sendString(26736, "@or2@  <img=37>@whi@ Slayer Information");
		...
		player.getPacketSender().sendString(26743, "@or2@  <img=35>@whi@ Tools Information");
		...
		player.getPacketSender().sendString(57007, "CelestialX.org");
