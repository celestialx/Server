			...
			if (pickaxe > 0) {
				if (miningLevel >= o.getLevelReq()) {
					...
					if (miningLevel >= p.getReq()) {
						...
						boolean lowLevelOres = (o == o.Clay || o == o.Copper || o == o.Iron || o == o.Silver || o == o.Tin);
						boolean mediumLevelOres = (o == o.Gold || o == o.Mithril || o == o.Coal);
						boolean highLevelOres = (o == o.Adamantite || o == o.Runite);
						int i;

						if (lowLevelOres)
							i = Misc.random(8, 12) + miningLevel/20 ;
						else if (mediumLevelOres)
							i = Misc.random(6,8) + miningLevel/30;
						else if (highLevelOres)
							i = Misc.random(2,4)+ miningLevel/40;
						else 
							i = 28;
						...
						player.setCurrentTask(new Task(delay >= 2 ? delay : 1, player, false) {
							...
							public void execute() {
								...
								if (cycle == reqCycle) {
									...
									if(o.getRespawn() > 0 && Misc.random(i) == 1) {
										player.performAnimation(new Animation(65535));
