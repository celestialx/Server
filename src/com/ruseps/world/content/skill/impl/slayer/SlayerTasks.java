...
public enum SlayerTasks {
	...
	VENENATIS(SlayerMaster.SUMONA, 2000, "Venenatis can be found deep in the wilderness using the Boss teleport.", 50000, new Position(3350, 3734)),
	...
	LIZARMAN(SlayerMaster.SUMONA, 6766, "The lizardman can be found using the Boss teleport.", 40000, new Position(2718, 9811)),
