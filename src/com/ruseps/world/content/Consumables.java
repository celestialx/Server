...
public class Consumables {
	 ...
	 */
	public static void eat(Player player, FoodType food, int slot) {
		...
		if (food != null && food == FoodType.KARAMBWAN) {
			if (food != null && player.getKarambwanTimer().elapsed(1800)) {
		...
		if (food != null && player.getFoodTimer().elapsed(1800)) {
	...
	public enum FoodType {
														...
														130), SWORDFISH(new Item(373), 140), MEAT_PIZZA(new Item(2293),
																145), MONKFISH(new Item(7946), 160), SHARK(
																		...
																		200), SEA_TURTLE(new Item(397), 210), MANTA_RAY(
																				new Item(391),
																				220), CAVEFISH(new Item(15266),
																						230), ROCKTAIL(new Item(15272),
																								230), KARAMBWAN(
																										new Item(3144),
																										180),
		/*
		...
		public static Map<Integer, FoodType> getTypes() {
			return types;
		}
	...
	public static boolean isDecantablePotion(int itemId) {
		String pot = ItemDefinition.forId(itemId).getName();
		return pot.contains("(3)") || pot.contains("(2)") || pot.contains("(1)") || pot.contains("(super combat)");
	}
	...
	public static void handlePotion(final Player player, final int itemId, final int slot) {
		...
		if (player.getPotionTimer().elapsed(900)) {
			...
			case 12695:
				player.performAnimation(new Animation(829));
				player.getInventory().getItems()[slot] = new Item(12697, 1);
				player.getInventory().refreshItems();
				drinkStatPotion(player, itemId, 12697, slot, 0, true);
				drinkStatPotion(player, itemId, 12697, slot, 1, true);
				drinkStatPotion(player, itemId, 12697, slot, 2, true);
				break;
			case 12697:
				player.performAnimation(new Animation(829));
				player.getInventory().getItems()[slot] = new Item(12699, 1);
				player.getInventory().refreshItems();
				drinkStatPotion(player, itemId, 12699, slot, 0, true);
				drinkStatPotion(player, itemId, 12699, slot, 1, true);
				drinkStatPotion(player, itemId, 12699, slot, 2, true);
				break;
			case 12699:
				player.performAnimation(new Animation(829));
				player.getInventory().getItems()[slot] = new Item(12701, 1);
				player.getInventory().refreshItems();
				drinkStatPotion(player, itemId, 12701, slot, 0, true);
				drinkStatPotion(player, itemId, 12701, slot, 1, true);
				drinkStatPotion(player, itemId, 12701, slot, 2, true);
				break;
			case 12701:
				player.performAnimation(new Animation(829));
				player.getInventory().getItems()[slot] = new Item(229, 1);
	...
	public static void drinkStatPotion(final Player player, int potion, int replacePotion, int slot, int skill,
		...
		player.getInventory().refreshItems();
		// boolean cbPot = potion == 9739 || potion == 9741 || potion == 9743 || potion
		// == 9745;
		boolean cbPot = potion == 12695 || potion == 12697 || potion == 12699 || potion == 12701;
