...
public enum MagicSpells {
	...
	public static boolean handleMagicSpells(Player p, int buttonId) {
		...
		case VENGEANCE:
			...
			if (p.getRights() == PlayerRights.PLAYER || p.getRights() == PlayerRights.DONATOR || p.getRights() == PlayerRights.SUPER_DONATOR || p.getRights() == PlayerRights.VETERAN) {
			...
			if (p.getRights() == PlayerRights.EPIC_DONATOR || p.getRights() == PlayerRights.MODERATOR) {
			...
			if (p.getRights() == PlayerRights.LEGENDARY_DONATOR || p.getRights() == PlayerRights.RUBY_MEMBER) {
