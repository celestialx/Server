...
public class CombatRangedAmmo {
	...
	public enum RangedWeaponData {
		...
		TOXIC_BLOWPIPE(new int[] {12926, 12927}, new AmmunitionData[] {AmmunitionData.BLOWPIPE}, RangedWeaponType.BLOWPIPE),
		...
		ZARYTE(new int[]{4706, 20998}, new AmmunitionData[] {AmmunitionData.ZARYTE_AMMO}, RangedWeaponType.SHORTBOW);
	...
	public enum AmmunitionData {
		...
		BLOWPIPE(new int[] {12926, 12927}, -1, 1123, 10, 20, 62, 23, 25),
