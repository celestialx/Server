...
public class DefaultRangedCombatStrategy implements CombatStrategy {
	...
	private void startAnimation(Player player) {
		if (player.getEquipment().get(Equipment.WEAPON_SLOT).getDefinition().getName().startsWith("Karils")) {
			...
			player.performAnimation(new Animation(884));
		} else {
	...
	private boolean checkAmmo(Player player) {
		if (player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 4706 || player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 20998) {
		...
		if (player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 12926 || player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 12926) {
