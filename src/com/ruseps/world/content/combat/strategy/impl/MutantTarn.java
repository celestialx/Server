...
public class MutantTarn implements CombatStrategy {
	...
	private static final Animation anim = new Animation(5617);
	private static final Animation anim2 = new Animation(5618);
	private static final Animation anim3 = new Animation(5617);

	private static final Graphic gfx1 = new Graphic(1935, 3, GraphicHeight.MIDDLE);
	private static final Graphic gfx2 = new Graphic(1003);
	private static final Graphic gfx3 = new Graphic(83);
			...
			TaskManager.submit(new Task(1, cB, false) {
				...
				protected void execute() {
					if (cB.getConstitution() <= 0) {
						target.getPacketSender().sendMessage("The Mutant was unsuccessful today.");
					...
					stop();
					new Projectile(cB, victim, 483, 44, 3, 43, 31, 0).sendProjectile();
