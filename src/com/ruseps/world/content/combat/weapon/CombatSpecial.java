...
public enum CombatSpecial {
    ...
    //harryl is a kanker ass fuck nigger - meradj
    ABYSSAL_WHIP(new int[]{	4151, 15441, 15442, 15443, 15444, 20061, 625}, 50, 1, 1, CombatType.MELEE, WeaponInterface.WHIP) {
                @Override
                public CombatContainer container(Player player, Character target) {
    ...
    ABYSSAL_TENT(new int[]{11554}, 50, 1.3, 2, CombatType.MELEE, WeaponInterface.WHIP) {
                ...
                //894, 895, 82, 20690, 19810, 11529, 11526, 625, 11527, 11528, 9707, 665, 13636, 3619,
				//14587, 81, 13444, 3626
            },
			  VINE_WHIP(new int[]{4705, 15441, 15442, 15443, 15444, 20061, 20690}, 60, 1.4, 2.4, CombatType.MELEE, WeaponInterface.WHIP) {
                @Override
                public CombatContainer container(Player player, Character target) {
			  ...
			  ZARYTE(new int[]{4706, 20998}, 50, 1.30, 2.90, CombatType.RANGED, WeaponInterface.SHORTBOW) {
                @Override
                public CombatContainer container(Player player, Character target) {
    ...
    DRAGON_WARHAMMER(new int[] { 20555 }, 50, 1.40, 1.9, CombatType.MELEE, WeaponInterface.WARHAMMER) {
        		@Override
        		public CombatContainer container(Player player, Character target) {
