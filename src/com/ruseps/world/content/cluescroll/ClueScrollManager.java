...
//import com.ruseps.util.chance.Chance;
//import com.ruseps.world.content.cluescroll.Clue.ClueType;
//import com.ruseps.world.content.cluescroll.scroll.EmoteScroll;
//import com.ruseps.world.content.cluescroll.scroll.MapScroll;
...
//
//		/* Map Scrolls - Easy */
//		CLUE_SCROLLS.put(2682, new MapScroll(2682, ClueDifficulty.EASY, new Position(3290, 3372, 0), 7045));
//		CLUE_SCROLLS.put(2683, new MapScroll(2683, ClueDifficulty.EASY, new Position(3092, 3226, 0), 7113));
//		CLUE_SCROLLS.put(2684, new MapScroll(2684, ClueDifficulty.EASY, new Position(2702, 3428, 0), 7162));
//		CLUE_SCROLLS.put(2685, new MapScroll(2685, ClueDifficulty.EASY, new Position(2970, 3414, 0), 17537));
//
//		/* Map Scrolls - Medium */
//		CLUE_SCROLLS.put(2803, new MapScroll(2803, ClueDifficulty.MEDIUM, new Position(3043, 3399, 0), 7271));
//		CLUE_SCROLLS.put(2805, new MapScroll(2805, ClueDifficulty.MEDIUM, new Position(2616, 3077, 0), 9043));
//		CLUE_SCROLLS.put(2807, new MapScroll(2807, ClueDifficulty.MEDIUM, new Position(3109, 3151, 0), 9275));
//		CLUE_SCROLLS.put(2809, new MapScroll(2809, ClueDifficulty.MEDIUM, new Position(2722, 3339, 0), 17634));
//
//		/* Emote Scrolls - Easy */
//		CLUE_SCROLLS.put(2677, new EmoteScroll(2677, ClueDifficulty.EASY, new Item[] { null, null, null, null, new Item(1133), null, null, new Item(1075), null, null, null, null, null, null }, new Position(2598, 3280, 0), 1, 2110, "", "", "Blow a raspberry at the monkey", "cage in Ardougne Zoo.", "Equip a studded body and bronze", "platelegs.", "", "", ""));
//		CLUE_SCROLLS.put(2678, new EmoteScroll(2678, ClueDifficulty.EASY, new Item[] { null, null, new Item(1654), new Item(1237), null, null, null, null, null, null, null, null, new Item(1635), null }, new Position(2977, 3240, 0), 11, 2113, "", "", "Shrug in the mine near Rimmington,", "quip a gold necklace, a gold ring", "and a bronze spear.", "", "", ""));
//		CLUE_SCROLLS.put(2679, new EmoteScroll(2679, ClueDifficulty.EASY, new Item[] { null, null, new Item(1696), new Item(845), null, null, null, new Item(1067), null, null, null, null, null, null }, new Position(2728, 3348, 0), 1, 858, "", "", "Bow outside the entrance to the", "Legends' Guild. Equip iron platelegs,", "an emerald amulet and an oak", "longbow.", "", ""));
//		CLUE_SCROLLS.put(2680, new EmoteScroll(2680, ClueDifficulty.EASY, new Item[] { new Item(740), null, null, new Item(1307), null, null, null, null, null, null, new Item(1061), null, null, null }, new Position(2926, 3484, 0), 5, 862, "", "", "Cheer at the Druids' Circle. Equip", "a blue wizard hat, a bronze two-", "handed sword and leather boots.", "", "", "", ""));
//		CLUE_SCROLLS.put(2681, new EmoteScroll(2681, ClueDifficulty.EASY, new Item[] { null, null, new Item(1694), null, new Item(1103), null, null, null, null, null, null, null, new Item(1639), null }, new Position(2611, 3393, 0), 2, 2106, "", "", "Dance a jig by the entrance to the", "Fishing Guild, equip a sapphire", "amulet, an emerald ring and a", "bronze chainbody", "", "", ""));
//		
//		/* Emote Scrolls - Medium */
//		CLUE_SCROLLS.put(2801, new EmoteScroll(2801, ClueDifficulty.MEDIUM, new Item[] { new Item(658), null, null, new Item(1267), null, null, null, null, null, null, new Item(6328), null, null, null }, new Position(3370, 3428, 0), 1, 859, "", "", "Beckon in the Digsite, near the eastern", "winch. Equip a green hat, snakeskin", "boots and an iron pickaxe.", "", "", "", ""));
//	
//		/* Emote Scrolls - Hard */
//		CLUE_SCROLLS.put(2722, new EmoteScroll(2722, ClueDifficulty.HARD, new Item[] { null, null, null, new Item(1347), null, new Item(2890), null, new Item(2493), null, null, null, null, null, null }, new Position(2587, 3420, 0), 2, 2110, "", "", "Blow a raspberry in the Fishing Guild", "bank. Beware of double agents!", "Equip an elemental shield, blue", "dragonhide chaps and a rune", "warhammer", "", ""));
//		CLUE_SCROLLS.put(2723, new EmoteScroll(2723, ClueDifficulty.HARD, new Item[] { null, null, new Item(1731), null, null, null, null, null, null, null, null, null, new Item(1643), null }, new Position(2920, 3163, 0), 10, 2112, "", "Salute in the banana plantation.", "Beware of double agents!", "Equip a diamond ring, amulet", "of power and nothing on", "your chest and legs.", "", "", ""));
//		
//	}
//
//	/**
...
//		}
//
//		return new Item(RandomUtility.randomElement(scrolls).getScrollId());
//	}
//
...
//			player.sendMessage("You need at least 6 free slots to open this casket.");
//			return;
//		}
//
