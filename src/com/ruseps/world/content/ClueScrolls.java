...
public class ClueScrolls {
	...
	private static final String[] HINTS = { "Dig somewhere in the edgeville bank",
			...
			"Dig near the fourth minigame teleport", "Dig where players plant flowers", "Dig somewhere at home2", "Dig somewhere near some chickens", "Dig somewhere on the middle of barrows", "Dig in the cave of the giant bird", "Dig near the first few crawling hands"};
