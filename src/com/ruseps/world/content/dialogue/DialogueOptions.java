...
import com.ruseps.model.input.impl.EnterAmountOfLmsCoins;
import com.ruseps.model.input.impl.EnterAmountToRemoveFromCoffer;
	...
	public static void handle(Player player, int id) {
		...
		if (id == FIRST_OPTION_OF_FIVE) {
			...
			case 5:
				...
				if (player.getRights() == PlayerRights.PLAYER) {
					player.getPacketSender().sendMessage("You need to be a member to teleport to this zone.")
							.sendMessage("To become a member, visit CelestialX.org and purchase a scroll.");
					return;
				}
			...
			case 31:
				...
				break;
			case 45:
				player.getPacketSender().sendString(1, "http://CelestialX.org");
				break;
			}
			...
			case 69:
				TeleportHandler.teleportPlayer(player,
						new Position(3087 + Misc.getRandom(10), 3502 + Misc.getRandom(2)),
						player.getSpellbook().getTeleportType());
				break;
			...
			switch (player.getDialogueActionId()) {
			case 151:
				player.getPacketSender().sendEnterAmountPrompt("How many coins would you like to depoist?");
				player.setInputHandling(new EnterAmountOfLmsCoins());
				break;
			case 1000:
				player.getPacketSender().sendInterfaceRemoval();
			...
			switch (player.getDialogueActionId()) {
			case 151:
				player.getPacketSender().sendEnterAmountPrompt("How many coins would you like to withdraw?");
				player.setInputHandling(new EnterAmountToRemoveFromCoffer());
				break;
			case 1000:
