...
public class PlayerLoading {
	...
	public static int getResult(Player player, boolean force) {
		...
		try (FileReader fileReader = new FileReader(file)) {
			...
			if (reader.has("lms-coffer")) {
				player.setLmsCoffer(reader.get("lms-coffer").getAsInt());
			}
			...
			if (reader.has("bossInterface")) {
				player.bossInterface = reader.get("bossInterface").getAsInt();
			}
			...
			if (reader.has("easyTasks")) {
				player.setEasy(builder.fromJson(reader.get("easyTasks").getAsJsonArray(), int[].class));
			}
			
			if (reader.has("mediumTasks")) {
				player.setMedium(builder.fromJson(reader.get("mediumTasks").getAsJsonArray(), int[].class));
			}
			
			if (reader.has("hardTasks")) {
				player.setHard(builder.fromJson(reader.get("hardTasks").getAsJsonArray(), int[].class));
			}
			
			if (reader.has("eliteTasks")) {
				player.setElite(builder.fromJson(reader.get("eliteTasks").getAsJsonArray(), int[].class));
			}
			
			if (reader.has("completedTasks")) {
				player.setCompleted(builder.fromJson(reader.get("completedTasks").getAsJsonArray(), int[].class));
			}
			if (reader.has("clues")) {
				player.setCluesCompleted(builder.fromJson(reader.get("completedTasks").getAsJsonArray(), int[].class));
			}
