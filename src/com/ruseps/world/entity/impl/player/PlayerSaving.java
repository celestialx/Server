...
public class PlayerSaving {
	...
	public static void save(Player player) {
		...
		try (FileWriter writer = new FileWriter(file)) {
            ...
            object.addProperty("lms-coffer", new Integer(player. getLmsCoffer()));
			...
			object.addProperty("bossInterface", new Integer(player.bossInterface));
			...
			object.add("easyTasks", builder.toJsonTree(player.getEasy()));
			object.add("mediumTasks", builder.toJsonTree(player.getMedium()));
			object.add("hardTasks", builder.toJsonTree(player.getHard()));
			object.add("eliteTasks", builder.toJsonTree(player.getElite()));
			object.add("completedTasks", builder.toJsonTree(player.getCompleted()));
			object.add("clues", builder.toJsonTree(player.getCluesCompleted()));
