...
public class PacketSender {
   ...
   /* public void sendMbox() {
    	PacketBuilder out = new PacketBuilder(127, PacketType.SHORT);
    	for(int i = 0; i < VoteBox.rewards.length; i++) {
    		out.putShort(VoteBox.rewards[i][0] + 1);
    		out.putShort(VoteBox.rewards[i][1]);
    		out.put(VoteBox.rewards[i][2]);
    		player.getSession().queueMessage(out);
    	}
    }*/
