...
import com.ruseps.world.content.MegaMysteryBox;
...
public class ItemActionPacketListener implements PacketListener {
	...
	//	case 10943:
		...
		case 6201:
			//	final Graphic gfx1 = new Graphic(199, 3, GraphicHeight.LOW);

				//player.performGraphic(gfx1);
				MegaMysteryBox.open(player);
				break;
		// Donation Box
		case 6183:
		...
		case 6199:
			int rewards2[][] = {
					{ 3749, 3753, 10828, 1215, 4587, 4091, 4093, 4095, 4097, 1079, 1127, 1093, 15332, 3024, 15272, 6685,
							1434, 2, 536, 534, 1149, 1305, 1377, 1434, 1615, 3000, 3204, 2941, 2947, 2503, 15272, 2503,
							10499, 6199, 6326, 861, 1163, 1201, 6111, 544, 6199, 542, 5574, 5575, 5576, 1215, 3105,
							13734, 7400, 2572, 11118 }, // Common, 0
					{ 15501, 11133, 15126, 10828, 6199, 3751, 3753, 11884, 10589, 18782, 6739, 6739, 2577, 2581, 18782,
							15332, 15332, 15332, 11732, 6199, 10564, 6809, 4587, 1249, 3204, 1305, 1377, 1434, 6528,
							7158, 4153, 6, 8, 10, 12, 4675, 6914, 6889, 4716, 4718, 4720, 4722, 4745, 4747, 4749, 4751,
							4708, 4710,/* 4712, 4714, 4732, 4734, 4736, 4738, 4724, 4726, 4728, 4730, 4151, 11732, 6585,
							2577, 2581, 6737, 11235, 4675, 4087, 1187, 6914, 6889, 3140, 6916, 6918, 6920, 6922, 6924,
							6731, 6735, 6733 */}, // Uncommon, 1
					{ 3749, 3753,/* 10828, 1215, 4587, 4091, 4093, 4095, 4097, 1079, 1127, 6739, 15259, 15332, 15126,
							11856, 11854, 11852, 11846, 11850, 11732, 11848, 2577, 2581, 2572, 15501, 18782, 6920, 6922,
							11335, 15241, 15243, 6585, 4151, 11696, 11724, 11726, 11728, 11694, 11718, 11720, 11722,
							11700, 11716, 11698, 11730, 11283, 18349, 18351, 18353, 18355, 18357, 18359, 11484, 2527,
							12601, 15486, 15018, 15019, 15020, 15220*/ } // Rare, 2
			};
		...
		case 15501:
			int superiorRewards[][] = {
					{ 11133, 15126, 10828, 3751, 3753, 10589, 10564, 6809, 4587, 2581, 2577, 2577, 2577, 2581, 2581,
							18782, 18782, 18782, 1249, 3204, 1305, 4151, 6585, 1377, 1434, 6528, 7158, 4153, 6, 8, 10,
							12, 4675, 6914, 6889 }, // Uncommon, 0
					{ 6739, 15259, 15332, 2579, 6920, 6922, 15241, 11882, 4151, 13867, 6585, 6570, 11884, 11906, 11283,
							20084 }, // Rare, 1
					{ 6570, 15018, 15019, 15020, 15220, 11730, 11718, 11720, 11722, 11724, 11726, 13902, 13857, 11283,
							18349, 18353, 13896, 18357, 13899, 10551, 4151, 2577, }, // Epic, 2
					{ 11235, 17273, 14484, 11696, 11698, 11700, 20000, 20001, 20002, 13899, 11613, 19780, 20072, 15486,
							19336, 19337, 19338, 19339, 19340, 14009, 14010, 14008 } // Legendary, 3
			};
			double superiorNumGen = Math.random();
			/**
			 * Chances 40% chance of Uncommon Items - various high-end coin-bought gear 30%
			 * chance of Rare Items - Highest-end coin-bought gear, Some poor
			 * voting-point/pk-point equipment 20% chance of Epic Items -Better
			 * voting-point/pk-point equipment 10% chance of Legendary Items - Only
			 * top-notch voting-point/pk-point equipment
			 */
			int superiorRewardGrade = superiorNumGen >= 0.60 ? 0
					: superiorNumGen >= 0.30 ? 1 : superiorNumGen >= 0.10 ? 2 : 3;
