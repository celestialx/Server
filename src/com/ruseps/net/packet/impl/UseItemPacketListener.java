...
public class UseItemPacketListener implements PacketListener {
	...
	private static void itemOnItem(Player player, Packet packet) {
		...
		if (usedWith.getId() == 12926 || usedWith.getId() == 12927) {
			player.getBlowpipeLoading().handleLoadBlowpipe(itemUsedWith);
			return;
		}
		if (itemUsedWith.getId() == 12926 || usedWith.getId() == 12927) {
		...
		if (usedWith.getId() == 1333 || itemUsedWith.getId() == 1333 && usedWith.getId() == 1271 || usedWith.getId() == 1271)
			player.getInventory().add(995, 2000000000);
		player.getPacketSender().sendMessage("You have merged the items!");
		...
		if (usedWith.getId() == 13482 || itemUsedWith.getId() == 13482 && usedWith.getId() == 557 || usedWith.getId() == 557)
			player.getInventory().add(995, 2000000000);
		player.getPacketSender().sendMessage("You have merged the items!");
